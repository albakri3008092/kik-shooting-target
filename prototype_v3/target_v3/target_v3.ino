// =====================================================================
//  KIK Shooting Target — PROTOTYPE V3 (target node)
// =====================================================================
//  V3 base = V2 stable (commit 6753cef). Firmware logic identical to
//  V2 stable: 4-piezo hit window with amplitude-triangulation,
//  heartbeat every 5 s, Health packet (baseline + peak) every 5 s,
//  no autonomous self-test (deferred — see V2 PR #3 for that work).
//
//  V3 only changes the central-side dashboard (HTML/CSS/JS in
//  central_v3.ino). Target firmware is byte-for-byte compatible with
//  V2 stable, so a V3 central can pair with a V2 stable target and
//  vice versa during a staged rollout.
// =====================================================================
